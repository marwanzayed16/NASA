...
var all_questions = [
  {
    question_string: "Ocean gardens preserve ecological systems by:",
    choices: {
      correct: "Providing food resources.",
      wrong: [
        "Purifying water.",
...
Quiz.prototype.render = function (container) {
  ...
  $("#submit-button").click(function () {
    ...
    if (percentage === 1) {
      ...
      <p>Ocean gardens preserve ecological systems by providing food resources, purifying water, protecting coastlines, and ensuring economic sustainability. Ocean gardens are a vital part of marine ecological systems.</p>
      `;
    } else {
      message = `
      <p class="faild">Your answer is incorrect</p>
      <p>Ocean gardens preserve ecological systems by providing food resources, purifying water, protecting coastlines, and ensuring economic sustainability. Ocean gardens are a vital part of marine ecological systems.</p>
      `;
    }
...
var Question = function (question_string, correct_choice, wrong_choices) {
  ...
  this.correct_choice_index = Math.floor(
    Math.random(0, wrong_choices.length + 1)
  );
